  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1.5 md:pb-2 p-2.5 md:p-5">
          <CardTitle className="text-[11px] md:text-xs font-medium text-gray-600 group-hover:text-gray-700 transition-colors leading-tight">
            {title}
          </CardTitle>
          <div className="p-1.5 md:p-2 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 group-hover:from-blue-200 group-hover:to-indigo-200 transition-all duration-300 shadow-sm">
            <Icon className={`h-3 w-3 md:h-4 md:w-4 ${iconColor} group-hover:scale-110 transition-transform duration-300`} />
          </div>
        </CardHeader>
        <CardContent className="pt-0 p-2.5 md:p-5 md:pt-0">
          <div className="text-lg md:text-2xl font-bold text-gray-900 mb-1 md:mb-2 group-hover:text-blue-900 transition-colors">
            {value}
          </div>
          <div className="flex items-center space-x-2">
            <div className={`inline-flex items-center px-2 py-0.5 md:py-1 rounded-full text-[11px] font-medium shadow-sm ${
              changeType === 'positive' 
